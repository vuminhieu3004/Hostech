...
const AuthPage = () => {
  ...
  return (
    <>
      ...
      <div className="relative max-w-7xl mx-auto h-screen overflow-hidden p-[10%] pt-[7%]">
        <section className="relative w-[43%] mx-auto flex">
          <div
            className={`absolute inset-0 flex flex-col justify-center h-120 bg-white border shadow-2xl shadow-blue-500 border-gray-300 rounded-[10px] items-start p-10 transition-all duration-500 ease-in-out
